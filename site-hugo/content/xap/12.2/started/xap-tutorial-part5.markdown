...
{{%refer%}}[Elastic Processing Unit]({{%currentjavaurl%}}/elastic-processing-unit-overview.html){{%/refer%}}
...
{{%refer%}}[Web Application Support]({{%currentjavaurl%}}/web-application-support-overview.html){{%/refer%}}
