...
|[Jetty](http://eclipse.org/jetty/)         | 8.1.8, 9.1.3 | [Apache2](http://www.eclipse.org/jetty/licenses.html) | Web Container | [Jetty Processing Unit Container](/xap/11.0/dev-java/web-jetty-processing-unit-container.html) |
