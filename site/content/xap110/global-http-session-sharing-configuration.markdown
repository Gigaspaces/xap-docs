...
|policy.connector|Instance of space connector implementation{{<wbr>}}See [Space Connector Section](#space-connector-manages-connections-with-the-space)|Yes|$connector|
...
|cacheManager.<br>connector|Instance of space connector implementation{{<wbr>}}See [Space Connector Section](#space-connector-manages-connections-with-the-space)|Yes|$connector|
