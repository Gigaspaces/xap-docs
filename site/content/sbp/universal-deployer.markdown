...
|-cluster |Set cluster parameters|schema=partitioned-sync2backup  : The cluster schema<br>total_members=1,1               : The number of instances and number of backups | |
...
|-properties | Location of context level properties file or list of properties. Examples:<br>`-properties embed://prop2=value2;prop3=value3` or `-properties file://d:/context.properties`| | |
