...
It's implementation class is [`org.openspaces.pu.container.standalone.StandaloneProcessingUnitContainer`]({{% api-javadoc %}}/org/openspaces/pu/container/standalone/StandaloneProcessingUnitContainer.html).
