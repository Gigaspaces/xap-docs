...
{{%learn "/xap/10.2/dev-java/the-space-configuration.html"%}}
...
{{%learn "/xap/10.2/dev-java/client-side-caching.html"%}}
...
{{%learn "/xap/10.2/dev-java/space-object-id-operations.html"%}}
...
{{%learn "/xap/10.2/dev-java/routing-in-partitioned-spaces.html"%}}
{{%/info%}}
...
{{%learn "/xap/10.2/dev-java/document-pojo-interoperability.html"%}}
{{%/info%}}
...
{{%learn "/xap/10.2/dev-java/the-space-operations.html"%}}
...
{{%learn "/xap/10.2/dev-java/change-api.html"%}}
...
{{%learn "/xap/10.2/dev-java/query-sql.html"%}}
...
{{%learn "/xap/10.2/dev-java/query-nested-properties.html"%}}
...
{{%learn "/xap/10.2/dev-java/query-partial-results.html"%}}
...
{{%learn "/xap/10.2/dev-java/document-api.html"%}}
...
{{%learn "/xap/10.2/dev-java/indexing-overview.html"%}}
...
{{%learn "/xap/10.2/dev-java/other-data-access-apis.html"%}}
