...
```
{{%learn "/xap101/transaction-management.html"%}}
...
{{%learn "/xap101/polling-container.html"%}}
...
{{%learn "/xap101/notify-container.html"%}}
...
{{%learn "/xap101/task-execution-over-the-space.html"%}}
...
{{%learn "/xap101/space-based-remoting.html"%}}
...
```
{{%learn "/xap101/transaction-optimistic-locking.html"%}}
...
```
{{%learn "/xap101/transaction-pessimistic-locking.html"%}}
...
{{%learn "/xap101/transaction-read-modifiers.html"%}}
