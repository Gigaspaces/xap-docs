...
{{% refer %}}It is assumed that you have read the [Writing Existing CPP Class to Space](./cpp-writing-existing-class-to-space.html) example which serves as a starting point for this example.{{% /refer %}}
