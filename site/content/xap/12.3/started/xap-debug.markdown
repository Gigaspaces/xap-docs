...
|-properties embed://[property1 name]=<br>[property1 value];<br>[property2 name]=<br>[property2 value] | Allows you to [directly inject properties]({{%currentjavaurl%}}/deployment-properties.html) to the processing unit at startup time. |
