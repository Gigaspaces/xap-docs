...
{{% refer %}}See the [Memory Management Facilities](../dev-java/memory-management-overview.html) for details about the differences between `ALL_IN_CACHE` and the `LRU` cache policies.{{% /refer %}}
