...
In addition to hosting data, this processing unit takes advantage of XAP's collocation of business logic in the form of Event Processing and Space Based Remoting.
