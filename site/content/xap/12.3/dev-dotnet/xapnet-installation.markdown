...
XAP.NET is packaged as a standard Windows Installer package (.msi file). You can download [the latest version[](http://www.gigaspaces.com/xap-download).
...
- **NET v4.0** -- Contains XAP.NET for .NET 4.0 (or later)
    - **Bin** -- Contains binaries (Executables and dll files) of the product.
        ...
        - **ServicesManager.exe** - [GigaSpaces Services Manager](../dev-dotnet/gigaspaces-services-manager.html).
