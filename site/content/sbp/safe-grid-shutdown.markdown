...
{{% note %}}
 This example uses multicast to discover the service grid components. For unicast discovery, you can use the  [addLocator()]({{%api-javadoc%}}/org/openspaces/admin/AdminFactory.html#addLocator) method with a LUS address.
{{% /note %}}
