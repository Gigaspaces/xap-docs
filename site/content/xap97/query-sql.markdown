...
{{%panel "The following operations fully support GigaSpaces `SQLQuery`:"%}}
- `count`
- `clear`
...
{{%panel "SQLQuery supports the following: "%}}
...
{{%panel "SQLQuery does not support the following: "%}}
...
{{%panel "Reserved Separators and Operators:"%}}
:= || ; . ROWTYPE ~ < <= >  >= => != <> \(+\) ( ) \* / + - ? \{ \}
{{% /panel %}}
