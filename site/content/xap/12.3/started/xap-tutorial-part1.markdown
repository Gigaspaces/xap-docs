...
|  Query   |  Description   |
|:-----|:-------|
|<nobr>shape1 spatial:intersects shape2 <nobr>| The intersection between shape1 and shape 2 is not empty (i.e. some or all of shape1 overlaps some or all of shape2).|
