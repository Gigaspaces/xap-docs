...
```
{{%learn "/xap/10.1/dev-java/transaction-management.html"%}}
...
{{%learn "/xap/10.1/dev-java/polling-container.html"%}}
...
{{%learn "/xap/10.1/dev-java/notify-container.html"%}}
...
{{%learn "/xap/10.1/dev-java/task-execution-over-the-space.html"%}}
...
{{%learn "/xap/10.1/dev-java/space-based-remoting.html"%}}
...
```
{{%learn "/xap/10.1/dev-java/transaction-optimistic-locking.html"%}}
...
```
{{%learn "/xap/10.1/dev-java/transaction-pessimistic-locking.html"%}}
...
{{%learn "/xap/10.1/dev-java/transaction-read-modifiers.html"%}}
