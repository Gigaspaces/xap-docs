...
mule
      http://www.openspaces.org/schema/mule/os-eventcontainer http://www.openspaces.org/schema/{{%currentversion%}}/mule/{{%version "mule"%}}/mule/{{%version mule%}}/mule-os-eventcontainer.xsd">
