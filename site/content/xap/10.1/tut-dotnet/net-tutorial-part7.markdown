...
{{%learn "/xap/10.1/dev-dotnet/direct-persistency.html"%}}
...
{{%learn "/xap/10.1/dev-dotnet/asynchronous-persistency-with-the-mirror.html"%}}
...
{{%learn "/xap/10.1/dev-dotnet/hibernate-space-persistency.html"%}}
