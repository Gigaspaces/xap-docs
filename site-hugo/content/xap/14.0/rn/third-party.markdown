...
| [Maven](http://maven.apache.org/) | 3.2.5| [Apache2](https://www.apache.org/licenses/) | No | OpenSpaces Maven Integration |
| [Ant](http://ant.apache.org/) | 1.9.4 | [Apache2](http://www.apache.org/licenses/LICENSE-2.0.html) | No | Examples |
|[Apache Zookeeper](https://zookeeper.apache.org/) | 3.4.12 | [Apache2](https://www.apache.org/licenses/LICENSE-2.0.html) | No | XAP Manager |
...
|[InfluxDB](https://influxdata.com/) | 0.9 | [MIT](https://influxdb.com/docs/v0.9/about/licenses.html) | Metrics | [InfluxDB](../admin/metrics-influxdb-reporter.html) |
|[Jetty](http://eclipse.org/jetty/)         |  9.3.25 | [Apache2](http://www.eclipse.org/jetty/licenses.html) | Web Container | [Jetty Processing Unit Container](../dev-java/web-jetty-processing-unit-container.html) |
